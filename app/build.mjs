...
const pages = [
  ["ch0.html", "src/app_ch0.js", "data/artifact_ch0.json"],
  ["index.html", "src/app.js", "data/artifact.json"],
...
for (const [htmlFile, appFile, artFile] of pages) {
  ...
  const app = read(appFile)
    .replace(/^import[\s\S]*?from\s+"\.\/model\.js(?:\?v=\d+)?";\s*/m, "")    // drop model import
    .replace(/await loadArtifact\("data\/[\w.]+\.json"\)/, "window.__ART");   // inline the data
